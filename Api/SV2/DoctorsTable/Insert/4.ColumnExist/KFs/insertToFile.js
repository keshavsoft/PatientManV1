...
const StartFunc = ({ }) => {
  ...
  let LocalinDataToInsert = {DoctorName : LocalCoumnDoctorName,DoctorDepartment : LocalCoumnDoctorDepartment,DoctorAvailability : LocalCoumnDoctorAvailability,DoctorCaption : LocalCoumnDoctorCaption};
